...
def check_versions(errors: list[str]) -> None:
    ...
    init_source = read_utf8(ROOT / "src/kofun/__init__.py", errors)
    cli_source = read_utf8(ROOT / "src/kofun/cli.py", errors)
...
def check_verification_summary(errors: list[str]) -> None:
    ...
    expected_paths = {
        ("schema",): "kofun.verification/v1",
        ("toolchain", "kofun"): "0.2.0-bootstrap",
        ("tests", "python_unit"): 31,
        ("tests", "kofun_language"): 5,
