...
| [#748](https://github.com/hjosugi/kofun/issues/748) | `writer-c` | in-progress | P0 | S | 2026-07-28 | 2026-07-29 | 2026-07-30 | medium | selfhost: accept List[Text] and indexing in S (#622) |
| [#550](https://github.com/hjosugi/kofun/issues/550) | `writer-c` | in-progress | P1 | M | 2026-07-30 | 2026-08-04 | 2026-08-05 | medium | Implicit return of the final expression — and the lambda/function inconsistency |
| [#609](https://github.com/hjosugi/kofun/issues/609) | `writer-c` | in-progress | P1 | M | 2026-08-05 | 2026-08-10 | 2026-08-13 | medium | Stage 2 sidecar projector: map semantic events into atomic CLI output |
...
| [#636](https://github.com/hjosugi/kofun/issues/636) | `writer-c` | in-progress | P1 | M | 2026-08-11 | 2026-08-14 | 2026-08-17 | medium | Standard library charter: batteries-included coverage, tiers, compatibility, and update policy |
...
| [#637](https://github.com/hjosugi/kofun/issues/637) | `writer-c` | in-progress | P1 | M | 2026-08-17 | 2026-08-20 | 2026-08-25 | medium | Discovery query v1: project inferred types and callable operations from semantic facts |
...
| [#332](https://github.com/hjosugi/kofun/issues/332) | `writer-c` | ready | P1 | M | 2026-08-21 | 2026-08-26 | 2026-08-27 | medium | Traits frontend: resolve coherent concrete implementations |
...
| [#551](https://github.com/hjosugi/kofun/issues/551) | `writer-c` | ready | P1 | M | 2026-08-27 | 2026-09-01 | 2026-09-03 | medium | Law declarations: make Monad a library law, not a compiler keyword |
| [#626](https://github.com/hjosugi/kofun/issues/626) | `writer-c` | ready | P1 | M | 2026-09-02 | 2026-09-07 | 2026-09-08 | medium | Composable sequencing syntax: Result-first propagation and law-generic bind |
...
| [#627](https://github.com/hjosugi/kofun/issues/627) | `writer-c` | ready | P1 | M | 2026-09-08 | 2026-09-11 | 2026-09-14 | medium | Reactive programming: small Stream/Signal protocol with explicit demand and ownership |
...
| [#27](https://github.com/hjosugi/kofun/issues/27) | `writer-c` | needs-detail | P1 | M | 2026-09-14 | 2026-09-21 | 2026-09-23 | low | Sample: end-to-end JSON API service |
...
| [#281](https://github.com/hjosugi/kofun/issues/281) | `writer-b` | needs-detail | P1 | M | 2026-09-22 | 2026-09-29 | 2026-09-30 | low | Position paper: what replacing C and Rust actually requires |
| [#533](https://github.com/hjosugi/kofun/issues/533) | `writer-c` | needs-detail | P1 | L | 2026-09-22 | 2026-10-05 | 2026-10-08 | low | Show where ownership goes: LSP hover, inlay hints, and diagnostics |
| [#554](https://github.com/hjosugi/kofun/issues/554) | `writer-b` | needs-detail | P1 | S | 2026-09-30 | 2026-10-05 | 2026-10-09 | low | Backend strategy: reject MLIR, keep the self-hosted backend — with measured costs |
| [#555](https://github.com/hjosugi/kofun/issues/555) | `writer-a` | needs-detail | P1 | S | 2026-10-05 | 2026-10-08 | 2026-10-12 | low | Concurrency: scoped parallelism needs no new machinery; ownership helps here |
| [#556](https://github.com/hjosugi/kofun/issues/556) | `writer-b` | needs-detail | P1 | S | 2026-10-06 | 2026-10-09 | 2026-10-13 | low | Effect systems: ship pure/impure first; multi-shot continuations are unsound with take |
| [#557](https://github.com/hjosugi/kofun/issues/557) | `writer-c` | needs-detail | P1 | S | 2026-10-06 | 2026-10-09 | 2026-10-14 | low | Reading list for the type checker: what to copy, what to skip |
| [#569](https://github.com/hjosugi/kofun/issues/569) | `writer-a` | needs-detail | P1 | S | 2026-10-09 | 2026-10-14 | 2026-10-15 | low | Austral: make authority explicit with affine capability values |
...
| [#571](https://github.com/hjosugi/kofun/issues/571) | `writer-c` | needs-detail | P1 | S | 2026-10-12 | 2026-10-15 | 2026-10-19 | low | Austral/Nim: support zero-copy borrowed results without user-written lifetimes |
| [#573](https://github.com/hjosugi/kofun/issues/573) | `writer-a` | needs-detail | P1 | S | 2026-10-15 | 2026-10-20 | 2026-10-21 | low | Odin: make allocator choice a scoped, effect-tracked capability |
...
| [#710](https://github.com/hjosugi/kofun/issues/710) | `writer-c` | needs-detail | P1 | L | 2026-10-16 | 2026-10-29 | 2026-11-02 | low | Compiler-native Decimal: implement the accepted language design across all backends |
| [#638](https://github.com/hjosugi/kofun/issues/638) | `writer-a` | in-progress | P2 | M | 2026-10-21 | 2026-10-26 | 2026-10-27 | medium | HTTP client contract: streaming, redirects, TLS, cancellation, and bounded resources |
...
| [#640](https://github.com/hjosugi/kofun/issues/640) | `writer-a` | in-progress | P2 | M | 2026-10-27 | 2026-10-30 | 2026-11-03 | medium | Benchmark harness contract: warmup, sampling, allocation metrics, and reproducible reports |
...
| [#742](https://github.com/hjosugi/kofun/issues/742) | `writer-c` | ready | P2 | M | 2026-10-30 | 2026-11-04 | 2026-11-05 | medium | Validation accumulation: collect independent errors without running dependent checks |
...
| [#768](https://github.com/hjosugi/kofun/issues/768) | `writer-b` | needs-decision | P2 | S | 2026-11-12 | 2026-11-18 | 2026-11-19 | low | Move the generated backlog corpus out: 22.6% of tracked bytes that no gate reads |
| [#558](https://github.com/hjosugi/kofun/issues/558) | `writer-c` | needs-detail | P2 | S | 2026-11-16 | 2026-11-19 | 2026-11-20 | low | What verification actually costs — and why proof-to-code ratios don't measure dependent types |
| [#572](https://github.com/hjosugi/kofun/issues/572) | `writer-a` | needs-detail | P2 | S | 2026-11-17 | 2026-11-20 | 2026-11-23 | low | Nim: infer last-use moves and add a compile-time move assertion |
...
| [#767](https://github.com/hjosugi/kofun/issues/767) | `writer-b` | needs-detail | P2 | M | 2026-12-03 | 2026-12-10 | 2026-12-11 | low | Move the website out: site/, app/, and the Next/Cloudflare/npm manifests |
| [#769](https://github.com/hjosugi/kofun/issues/769) | `writer-c` | needs-decision | P3 | S | 2026-12-08 | 2026-12-14 | 2026-12-15 | low | Settle docs/: move the 9 documents no manifest resolves, record why the other 27 stay |

## Weekly calendar

| Week of | Active issues | Delivered | Writer load |
|---|---|---|---:|
| 2026-07-27 | #550, #618, #723, #748 | #748 | 12/15 |
| 2026-08-03 | #550, #609, #618, #723 | #550 | 14/15 |
| 2026-08-10 | #609, #618, #622, #636, #723, #724 | #609, #618, #723 | 12/15 |
| 2026-08-17 | #271, #332, #622, #636, #637, #724 | #622, #636 | 13/15 |
| 2026-08-24 | #271, #272, #332, #551, #637, #724, #725 | #271, #332, #637, #724 | 13/15 |
| 2026-08-31 | #272, #274, #551, #626, #725 | #272, #551 | 13/15 |
| 2026-09-07 | #274, #625, #626, #627, #725, #726 | #274, #626, #725 | 13/15 |
| 2026-09-14 | #27, #625, #627, #726 | #627 | 14/15 |
...
| 2026-10-12 | #555, #556, #557, #569, #570, #571, #573, #574, #710 | #555, #556, #557, #569, #570 | 15/15 |
| 2026-10-19 | #571, #573, #574, #638, #639, #710 | #571, #573, #574 | 15/15 |
| 2026-10-26 | #70, #638, #639, #640, #710, #742 | #638, #639 | 15/15 |
| 2026-11-02 | #70, #640, #710, #735, #736, #740, #742, #757 | #70, #640, #710, #742, #757 | 15/15 |
| 2026-11-09 | #735, #736, #740, #768 | #735 | 15/15 |
| 2026-11-16 | #558, #572, #576, #644, #736, #740, #768 | #558, #736, #740, #768 | 15/15 |
| 2026-11-23 | #572, #576, #644, #645, #646 | #572, #576 | 15/15 |
| 2026-11-30 | #644, #645, #646, #647, #648, #767 | #644, #645, #646 | 15/15 |
| 2026-12-07 | #647, #648, #767, #769 | #647, #648, #767 | 11/15 |
| 2026-12-14 | #769 | #769 | 1/15 |
