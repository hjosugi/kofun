...
| stable diagnostics | canonical registry plus executable family owners; Stage 2 retains 33/33 codes and 3 explicit span debts | `tests/diagnostics/`, `make diagnostics` | `stable-diagnostics` |
