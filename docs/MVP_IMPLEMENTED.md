...
| Stage 2 must-fail diagnostic corpus | 25/25 active codes; 3 span debts | `tests/diagnostics/stage2/run.sh` |
| deterministic compiler fuzz smoke tests | 128 grammar + 48 arithmetic differential + 32 value-if + 32 match-guard cases | `tests/fuzz/` |
