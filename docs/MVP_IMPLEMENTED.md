...
| x86-64 native Text-returning helper | bounded two-argument compiler-shaped bridge with one local and concatenation | `bootstrap/native/check.sh` |
...
| Stage 2 must-fail diagnostic corpus | 33/33 active canonical codes; 3 span debts | `tests/diagnostics/stage2/run.sh` |
