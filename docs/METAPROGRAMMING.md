...
Interactive type and callable-operation discovery is compiler-backed and
specified separately in
[`DEVELOPER_DISCOVERY.md`](DEVELOPER_DISCOVERY.md). Normal release artifacts
do not retain metadata for that tooling feature. Any future runtime `TypeInfo`
profile must reuse its stable identities and disclosure rules and remains
blocked on #454.
