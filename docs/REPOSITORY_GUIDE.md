...
- `check.sh` builds the seed and verifies its bounded block-and-loop Int/Bool
  Core.
...
| Stage 1 Int/Bool Core | `bootstrap/stage1/` | its README and `check.sh` | `make bootstrap` |
