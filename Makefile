...
help:
	@printf '%s\n' \
	  ...
	  'make imports-qualified Verify deterministic local qualified imports' \
...
verify: test diagnostics fuzz check bootstrap stage2 adt module-symbols imports-qualified native wasm tour c-abi rust-shim http cli-framework tui-framework stdlib build-system packages package-roots source-file-mapping namespaces module-identity visibility-spec visibility-syntax visibility-access re-exports-spec typed-sidecar-spec typed-sidecar-codec lsp roadmap syntax repository-check
