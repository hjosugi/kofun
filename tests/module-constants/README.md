...
| `non_literal.kofun` | `E2S147` — the initializer is not one integer literal |
| `function_clash.kofun` | `E2S147` — the name collides with a function |
| `type_clash.kofun` | `E2S147` — the name collides with a type |
| `duplicate.kofun` | `E2S148` — the same constant is declared twice |
| `mutable.kofun` | `E2S149` — `let mut` is refused as mutable module state |
