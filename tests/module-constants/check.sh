...
#      with the exact diagnostic — `E2S147` for a non-literal initializer and
#      for a name that collides with a function or type, `E2S148` for a
#      duplicate constant, and `E2S149` for `let mut`.
#
...
expect_refused non_literal E2S147
expect_refused function_clash E2S147
expect_refused type_clash E2S147
expect_refused duplicate E2S148
expect_refused mutable E2S149
