...
test "$diagnostic_cases" -eq 51 ||
    fail "expected all 51 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 294 ||
    fail "expected all 294 repository error companions, saw $repository_error_cases"
