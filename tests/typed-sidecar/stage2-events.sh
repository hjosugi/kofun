...
test "$diagnostic_cases" -eq 52 ||
    fail "expected all 52 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 295 ||
    fail "expected all 295 repository error companions, saw $repository_error_cases"
