...
test "$diagnostic_cases" -eq 48 ||
    fail "expected all 48 Stage 2 diagnostic fixtures, saw $diagnostic_cases"
...
test "$repository_error_cases" -eq 284 ||
    fail "expected all 284 repository error companions, saw $repository_error_cases"
