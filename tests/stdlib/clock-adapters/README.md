...
The executable producer for [#647](https://github.com/hjosugi/kofun/issues/647):
explicit monotonic and system clock identities, a closed clock error, an
affine clock handle, and a deterministic fake clock with a scripted waiter.
