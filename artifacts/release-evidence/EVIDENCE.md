...
| `compiler-seed` | `sh bootstrap/stage1/check.sh` | The Kofun seed and audited C transliteration emit byte-identical C for the arithmetic and Bool corpora; the Bool program executes with both zero-dividing short-circuit operands skipped. |
