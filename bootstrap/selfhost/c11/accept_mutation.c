...
/* Source: bootstrap/selfhost/c11/accept_mutation.kofun 0639a43a673cd7e5aa6572ad3119d19d5a99fab3837d603d6090a6c9b1ed6d1c */
...
int main(int argc, char **argv) {
    ...
    bool k_b3 = k_n6;
    int64_t k_n9 = k_b1;
    int64_t k_n10 = INT64_C(41);
    int64_t k_n8 = kofun_add(k_n9, k_n10);
    if (kofun_failed) return 1;
    k_b1 = k_n8;
    const char * k_n13 = k_b2;
    const char *k_n14 = "!";
    const char *k_n12 = kofun_rt_text_concat(k_n13, k_n14);
    k_b2 = k_n12;
    int64_t k_n18 = k_b1;
    int64_t k_n19 = INT64_C(42);
    bool k_n17 = k_n18 == k_n19;
    bool k_n16 = k_n17;
    if (k_n16) {
        const char * k_n21 = k_b2;
        const char *k_n22 = "go!";
        bool k_n20 = kofun_rt_text_equal(k_n21, k_n22);
        k_n16 = k_n20;
    }
    k_b3 = k_n16;
    int64_t k_n24 = k_b1;
    ...
    bool k_n26 = k_b3;
    if (k_n26) {
        int64_t k_n28 = INT64_C(0);
        k_b4 = k_n28;
    } else {
        int64_t k_n30 = INT64_C(9);
        k_b4 = k_n30;
    }
    int64_t k_n32 = k_b4;
    return (int)k_n32;
