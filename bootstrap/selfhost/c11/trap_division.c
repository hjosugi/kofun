...
/* Source: bootstrap/selfhost/c11/trap_division.kofun ded7f7c3fb73425dce747534bd254930eba32d6bd0792e4f6843145c9df6c5e9 */
...
static int64_t kofun_fn_halve(int64_t k_b2, int64_t k_b3);

static int64_t kofun_fn_halve(int64_t k_b2, int64_t k_b3) {
    int64_t k_n3 = k_b2;
    int64_t k_n4 = k_b3;
    int64_t k_n2 = kofun_floor_div(k_n3, k_n4);
...
int main(void) {
    ...
    (void)kofun_fn_halve;
    const char *k_n8 = "";
    int64_t k_n7 = kofun_rt_text_len(k_n8);
    int64_t k_b4 = k_n7;
    int64_t k_n11 = INT64_C(9);
    int64_t k_n12 = k_b4;
    int64_t k_n10 = kofun_fn_halve(k_n11, k_n12);
