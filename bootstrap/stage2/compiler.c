        ...
        if (type_start >= 0) {
            ...
            if (constant_close < 0) {
                ...
                if (mutable_constant) {
                    buffer_format(
                        &ir,
                        "error[E2S160]: module constant `%s` cannot be `mut`; "
                    ...
                    buffer_format(
                        &ir,
                        "error[E2S158]: module constant must be "
            ...
            if (duplicate || clashes) {
                ...
                if (duplicate) {
                    buffer_format(
                        &ir,
                        "error[E2S159]: duplicate module constant `%s` "
                        "at byte %" PRId64,
                        constant,
                        cursor
                    );
                    ...
                    buffer_format(
                        &ir,
                        "error[E2S158]: module constant `%s` conflicts with a "
