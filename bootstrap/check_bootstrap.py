...
from frost.c_backend import BackendFailure, CBackend, compile_c  # noqa: E402
from frost.evaluator import Evaluator  # noqa: E402
from frost.frontend import check_source  # noqa: E402


def verify_stage1() -> tuple[bool, str]:
    compiler_path = ROOT / "bootstrap" / "stage1" / "compiler.frost"
    fixture_path = ROOT / "bootstrap" / "fixtures" / "answer.frost"
    ...
    with tempfile.TemporaryDirectory(prefix="frost-bootstrap-") as directory:
        work = Path(directory)
        interpreted_c = work / "answer-interpreted.c"
        native_c = work / "answer-native.c"
        stage1_c = work / "frost-stage1.c"
        stage1_binary = work / "frost-stage1"
        answer_binary = work / "answer"

        # Path A: Stage 0 interpreter executes the Frost-written compiler.
