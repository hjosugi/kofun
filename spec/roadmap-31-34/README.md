...
| #34 | Inline diagnostics | No language server is packaged | open |
| #34 | Definition and hover | No semantic editor service exists | open |
| #34 | Interactive incremental performance | No incremental document engine or benchmark exists | open |
...
manifest entries remain open and that the VS Code extension remains
syntax-only.
...
The probe demonstrates real integer Core lowering. It does not demonstrate
generic type checking, compiler self-reproduction, native Stage 1, or an LSP.
